<template>
  ...
  >
    ...
    <div class="flex items-center gap-2 mb-2">
      <h2 class="text-lg font-semibold px-6 pt-0 pb-0">Behavior Overview</h2>
    </div>

    <!-- Info Row -->
    <div
        class="flex flex-col bg-secondary-background ml-4 p-5 rounded-xl gap-4 text-sm text-gray-300"
    >
      <!-- Stats Row -->
